...
public final class managerquestion_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("  var requiredCheckboxes = $(':checkbox[required]');\n");
      out.write("  requiredCheckboxes.on('change', function(e) {\n");
      out.write("    var checkboxGroup = requiredCheckboxes.filter('[name=\"' + $(this).attr('name') + '\"]');\n");
      out.write("    var isChecked = checkboxGroup.is(':checked');\n");
      out.write("    checkboxGroup.prop('required', !isChecked);\n");
      out.write("  });\n");
      out.write("  requiredCheckboxes.trigger('change');\n");
      out.write("});\n");
      out.write("</script>\n");
